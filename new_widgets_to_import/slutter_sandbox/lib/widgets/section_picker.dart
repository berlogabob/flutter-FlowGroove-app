...
class _SectionPickerState extends State<SectionPicker> with SingleTickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          Divider(color: Theme.of(context).colorScheme.outline.withValues(alpha: 0.3), thickness: 1.5),
          ...
          child: Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                color: color != null
                    ? AppColorPalette.getContrastingTextColor(color)
  ...
  void _showColorPicker(BuildContext context, String sectionName, Color currentColor) async {
