...
Your practice, tracked automatically — every metronome session is logged
(when it started, how long, which song, at what BPM). Nothing to set up.

- **Home dashboard** — the card on top of Home shows this week's minutes, your
  practice streak, and a 7-day graph. Tap it to open Practice.
