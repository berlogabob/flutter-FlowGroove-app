...
/// Custom AppBar for tool screens.
///
/// Features:
...
class ToolAppBar {
  ...
  /// Builds a tool AppBar with back button and menu.
  ///
  ...
  /// Builds a simple AppBar with only back button (no menu).
  ///
  /// Use this for tools that don't need a menu.
  static PreferredSizeWidget buildSimple(
    BuildContext context, {
    required String title,
    VoidCallback? onBack,
  }) {
    return build(context, title: title, menuItems: null, onBack: onBack);
  }
}
