...
class _ColorPickerDialogState extends State<ColorPickerDialog>
  ...
  void initState() {
    ...
    _hexController.text = SectionColorPalette.colorToHex(widget.initialColor);
  }
      ...
      children: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            foregroundColor: SectionColorPalette.getContrastingTextColor(
              _selectedColor,
            ),
          ),
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          runSpacing: 8,
          children: [
            for (final color in SectionColorPalette.getSuggestedColors(
              widget.sectionName,
            ))
              _buildColorCircle(context, color),
          ],
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          ...
          _hexController.text = SectionColorPalette.colorToHex(color);
        });
      },
      child: Container(
        width: 48,
  ...
  Widget _buildHexInput(BuildContext context) {
    return TextField(
      ...
      onChanged: (value) {
        if (value.length == 6) {
          final color = SectionColorPalette.hexToColor(value);
          if (color != null) {
            setState(() {
              _selectedColor = color;
            });
  ...
  Widget _buildHexPresets(BuildContext context) {
    return Wrap(
      spacing: 8,
      runSpacing: 8,
      children: SectionColorPalette.hexPresets.entries.map((entry) {
