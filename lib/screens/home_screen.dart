          ...
          children: [
            Expanded(
              child: _buildStatCard(
                ...
                color: MonoPulseColors.accentOrange,
                onTap: () => GoRouter.of(context).go('/main/songs'),
              ),
            ),
            ...
            Expanded(
              child: _buildStatCard(
                ...
                onTap: () => GoRouter.of(context).go('/main/bands'),
              ),
            ),
            const SizedBox(width: MonoPulseSpacing.md),
            Expanded(
              child: _buildStatCard(
                ...
                color: MonoPulseColors.textSecondary,
                onTap: () => GoRouter.of(context).go('/main/setlists'),
              ),
            ),
          ],
        ),
          ...
          children: [
            Expanded(
              child: _buildActionButton(
                ...
                icon: Icons.add,
                label: 'Song',
                onTap: () => GoRouter.of(context).go('/main/songs/add'),
              ),
            ),
            const SizedBox(width: MonoPulseSpacing.md),
            Expanded(
              child: _buildActionButton(
                ...
                label: 'Band',
                onTap: () => GoRouter.of(context).go('/main/bands/create'),
              ),
            ),
          ],
        ),
          ...
          children: [
            Expanded(
              child: _buildActionButton(
                ...
                label: 'Setlist',
                onTap: () => GoRouter.of(context).go('/main/setlists/create'),
              ),
            ),
            const SizedBox(width: MonoPulseSpacing.md),
            Expanded(
          ...
          children: [
            Expanded(
              child: _buildFutureTool(
                ...
                icon: Icons.tune,
                label: 'Tuner',
                onTap: () => GoRouter.of(context).go('/main/tuner'),
              ),
            ),
            const SizedBox(width: MonoPulseSpacing.md),
            Expanded(
              child: _buildFutureTool(
                ...
                icon: Icons.speed,
                label: 'Metronome',
                onTap: () => GoRouter.of(context).go('/main/metronome'),
              ),
            ),
          ],
        ),
