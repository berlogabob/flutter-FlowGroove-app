...
```bash
curl -X POST "https://api.telegram.org/bot***REMOVED-SECRET***/setWebhook?url=https://us-central1-repsync-app-8685c.cloudfunctions.net/telegramWebhook"
```

### 3. Verify Webhook

```bash
curl "https://api.telegram.org/bot***REMOVED-SECRET***/getWebhookInfo"
```
...
# Set webhook
curl -X POST "https://api.telegram.org/bot***REMOVED-SECRET***/setWebhook?url=<YOUR_FUNCTION_URL>"
